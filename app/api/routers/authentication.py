...
from models.user import User, UserInRegister, UserInResponse
...
@router.post("/register", response_model=UserInResponse, tags=["authentication"], status_code=HTTP_201_CREATED)
async def register(
